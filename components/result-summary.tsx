...
import { currentDatasetVersion } from "@/lib/dataset-version";
...
export function ResultSummary() {
  ...
  const officialSpecialtyLink = primary.job.officialSpecialtySlugs[0];
  const hasUpdatedData = session.datasetVersion?.officialSnapshotId !== currentDatasetVersion.officialSnapshotId;
